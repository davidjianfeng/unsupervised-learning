...
out = 'C:/Users/HP/Desktop/classes/GT/HW3/clusteringICA/'
...
facet = sns.lmplot(data=digits2D, x = 'x', y = 'y', hue = 'target', fit_reg= False, legend = True, legend_out = True)

LendingClub2D = pd.read_csv('C:/Users/HP/Desktop/classes/GT/HW3 LC/clustering/LendingClub2D.csv',header=0,sep=',')
LendingClub2D = LendingClub2D.sample(1000)
facet = sns.lmplot(data=LendingClub2D, x = 'x', y = 'y', hue = 'target', fit_reg= False, legend = True, legend_out = True, markers =["1","x"])
